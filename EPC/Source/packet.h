...
#define STAT_EPC_SFTRST     0x04            //программный сброс
...
//индексы для получения данных из структуры Packet_ApToEpc
#define ID_SENDER           0               //отправитель
#define ID_COMMAND          1               //код команды
...
#define ID_INTERVAL         10              //номер интервального значения мощности
