...
//**********************************************************************************
// Расчет кол-во секунд прошедших от 1900 года в значение дата/время.
// uint32_t secsarg - кол-во секунд прошедших от 1900 года
...
//**********************************************************************************
// Преобразует значение дата/время в кол-во секунд прошедших от 1900 года.
// struct timedate *ptr - структура содежащая текущее значение время-дата
